...
public class CollisionGravityScene extends Scene {
    ...
    public CollisionGravityScene(int objectCount, double sizeMin, double sizeMax, boolean doWallBounce, boolean drawFieldLines) {
        super("Orbit Scene");
    ...
    public void tick() {
        ...
        for (PhysicsCircle obj : getPhysicsObjects()) {
            ...
            //Do Collisions
            if (doCollisions) {
                for (PhysicsCircle otherObject : getPhysicsObjects()) {
